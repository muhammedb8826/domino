...
import { getCategorieById, getCategories, updateCategory } from "@/redux/features/category/categorySlice";
...
export default function CategoryEditModal({handleEditModalOpen, data}) {
