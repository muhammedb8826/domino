...
export const Categories = () => {
  ...
  const handleEditModalOpen = (id: string) => {
    const findData = categories.find((data) => data.id === id);
    setData(findData);
  ...
  const categoriesContent = categories.map((category) => (
    <tr key={category.id}>
      ...
      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
        <p className="text-black dark:text-white">{category.description}</p>
      </td>
      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
  ...
  return isLoading ? (
    ...
    <>
      ...
      {isModalOpen && (
        <CategoryRegistration handleModalOpen={handleModalOpen} />
      )}
      {isEditModalOpen && (
        <CategoryEditModal handleEditModalOpen={handleEditModalOpen} data={data} />
      )}
    </>
  );
};
