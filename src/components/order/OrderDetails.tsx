        ...
        <tbody key={index}>
          <tr className="bg-white border-b hover:bg-gray-50">
              ...
              <div className="ps-3">
                <div className="text-base font-semibold">
                  ...
                  onClick={()=>handleModalOpen(order.id)}
                   type="button" title="click to see order details" className="text-blue-500 hover:underline">{order.productName}</button> by {order.firstName} {order.lastName}
                </div>
            ...
            <td className="px-6 py-4">
              {order.id}-{order.productName}-{order.firstName}
            </td>
    ...
    <div className="p-4 overflow-y-scroll">
      ...
      {orders.length > 0 && (
        <>
         ...
         <ModalPage handleModalOpen={handleModalOpen} id={id} orders={orders}/>
