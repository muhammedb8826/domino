...
import { getRoles } from "../../redux/features/role/roleSlice";
...
const Permission = () => {
  ...
  useEffect(() => {
    // Initialize switch states when roles change
    if (roles.length > 0) {
      const initialSwitchStates = roles.map(() => false);
          ...
          {roles.map((role, index) => (
            ...
            >
              ...
              <ToggleSwitch
                  ...
                  label={switchStates[index] ? "active" : "not active"}
