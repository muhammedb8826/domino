...
const UserRegistration = ({ handleModalOpen, errors }: UserRegistrationProps) => {
  ...
  let errPhone = errors && errors.phone ? errors.phone[0] : null;
  let errEmail = errors && errors.email ? errors.email[0] : null;
  let errPassword = errors && errors.password ? errors.password[0] : null;
  ...
  }, [message, handleModalOpen, dispatch]);
